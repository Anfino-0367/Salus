...
if (isset($_POST['b1'])) {
    ...
    {
        $pas=rand('1000','9999');
    $ins_grp1=mysqli_query($dbcon,"insert into user_data values('','$t1','$t2','$t3','$t4','$t5','$t6','$nfn','$pas','0')");
    if($ins_grp1>0)
    {
...
<body>
	...
	<div class="main-top" id="home">
		...
		<div class="banner_w3lspvt-2">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="#" class="font-weight-bold">User Register</a></li>
			...
			<div class="row">
				...
				<div class="col-lg-6 mt-lg-0 mt-5">
                    ...
                    <div class="form-left-to-w3l">
                        ...
                        <input type="number"class="form-control" name="t2" placeholder="contact Info" required=""onkeyup="chkc(this.value)" /><span id="o3"></span>

                        <div class="clear"></div>
                    </div>
                    <div class="form-left-to-w3l">
                        <span class="fa fa-envelope" aria-hidden="true"></span>
                        <input type="email"class="form-control" name="t3" placeholder="Email" required=""onkeyup="vem(this.value)" /><span id="em"></span>
                  ...
                  <div class="form-left-to-w3l">
                        ...
                        <div id="locationField">
                                            <input class="form-control" name="t4" id="autocomplete" placeholder="Address"
             onFocus="geolocate1()"type="text">
                  ...
                  <div class="form-left-to-w3l">
                        ...
                        <input class="form-control" type="number" name="t5" placeholder="Pincode" required="">
                    ...
                    <div class="form-left-to-w3l ">
                        ...
                        <input type="password" class="form-control" name="t6" placeholder="Password" required="">
                        <div class="clear"></div>
                    </div>
					...
					<!-- //contact form grid ends here -->
                            ...
                            <div class="col-lg-6">
				    <img style="width: 730px;height: 550px" src="images/464745-PG35BZ-546.jpg">	 
                                </div>
			</div>
		</div>
	</div>
