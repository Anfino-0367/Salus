                ...
                <div class="ibox">
                    ...
                    <div class="ibox-body">
                        <?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from ser_reg where st='1' and pin='$r[4]'");
...
echo"$rt[1]";
                                    ...
                                    <td><a href="../img2/<?php echo $r_gal[8] ?>"><span style="color: blue" class="fa fa-file-archive-o"></span></a>&nbsp;&nbsp;<a href="enq.php?del=<?php echo $r_gal[0] ?>"><span style="color: red" class="fa fa-trash"></span></a>&nbsp;&nbsp;</td>
