...
<head>
    ...
    <!-- PLUGINS STYLES-->
    <link href="../ad_temp/./assets/vendors/jvectormap/jquery-jvectormap-2.0.3.css" rel="stylesheet" />
    <!-- THEME STYLES-->
...
<body class="fixed-navbar">
    <div class="page-wrapper">
      ...
      include 'menu.php';
        ...
        <div class="content-wrapper">
            ...
            <div class="row">
                <img style="width: 100%;height: 600px" src="../admin/pic/Business-Motion-Graphics.gif">
                </div>
        </div>
    </div>
    ...
    <!-- PAGE LEVEL PLUGINS-->
    <script src="../ad_temp/./assets/vendors/chart.js/dist/Chart.min.js" type="text/javascript"></script>
    <script src="../ad_temp/./assets/vendors/jvectormap/jquery-jvectormap-2.0.3.min.js" type="text/javascript"></script>
    <script src="../ad_temp/./assets/vendors/jvectormap/jquery-jvectormap-world-mill-en.js" type="text/javascript"></script>
    <script src="../ad_temp/./assets/vendors/jvectormap/jquery-jvectormap-us-aea-en.js" type="text/javascript"></script>
    <!-- CORE SCRIPTS-->
    <script src="../ad_temp/assets/js/app.min.js" type="text/javascript"></script>
    <!-- PAGE LEVEL SCRIPTS-->
    <script src="../ad_temp/./assets/js/scripts/dashboard_1_demo.js" type="text/javascript"></script>
</body>
