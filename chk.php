...
$log=mysqli_query($dbcon,"select * from user_data where em='$usr' and otp='$t1'");
...
<body>
	...
	<div class="main-top" id="home">
		...
		<div class="banner_w3lspvt-2">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="#" class="font-weight-bold"><script type="text/javascript">
                                function unblurText() {
                            var text = document.getElementById("blur-text");
                            text.style.color = ""; // Reset the color to default (unblurred)
                            text.style.textShadow = ""; // Remove the text shadow
                            text.style.cursor = "default"; // Reset cursor style
                            }
...
<center><strong>The OTP for Verification is <span id="blur-text"> <?php echo $r[8] ?> </span></strong></center></a></li>
			...
			<div class="row">
				...
				<div class="col-lg-8 mt-lg-0 mt-5">
					...
					<div class="contact-top1">
                        ...
                        <input type="text" class="form-control" name="t1" placeholder="Enter OTP" required="">
                    ...
                    <div class="btnn">
                        <button class="btn btn-cont-w3 btn-block mt-4" name="sub" type="submit">Verify OTP </button>
                    </div>
