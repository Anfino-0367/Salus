...
<head>
	<title><?php echo $title ?>| About Us :: Trinity Technologies</title>
	<!-- Meta tag Keywords -->
...
<body>
	...
	<div class="main-top" id="home">
		...
		<div class="banner_w3lspvt-2">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="../temp/index.html" class="font-weight-bold">Home</a></li>
			...
			<div class="row py-xl-4">
				<div class="col-lg-5 about-right-faq pr-5">
					...
					<p class="mt-2">Suspendisse porta erat sit amet eros sagittis, quis hendrerit libero aliquam. Fusce semper augue
						ac dolor
						efficitur.</p>
					<a href="../temp/about.html" class="btn button-style mt-sm-5 mt-4">Read More</a>
				</div>
				<div class="col-lg-7 welcome-right text-center mt-lg-0 mt-5">
					<img src="../temp/images/about.png" alt="" class="img-fluid" />
				</div>
			</div>
		</div>
	</div>
		...
		<div class="container py-xl-5 py-lg-3">
			<div class="row">
				<div class="col-lg-5 left-img-w3ls">
					<img src="../temp/images/b2.png" alt="" class="img-fluid" />
				</div>
			...
			<div class="row ab-info second pt-lg-4">
				<div class="col-lg-4 col-sm-6 ab-content text-center mt-lg-0 mt-4">
					<div class="ab-content-inner">
						<img src="../temp/images/t1.jpg" alt="news image" class="img-fluid">
				...
				<div class="col-lg-4 col-sm-6 ab-content text-center mt-lg-0 mt-4">
					<div class="ab-content-inner">
						<img src="../temp/images/t2.jpg" alt="news image" class="img-fluid">
						<div class="ab-info-con">
				...
				<div class="col-lg-4 col-sm-6 ab-content text-center mt-lg-0 mt-4">
					<div class="ab-content-inner">
						<img src="../temp/images/t3.jpg" alt="news image" class="img-fluid">
						<div class="ab-info-con">
