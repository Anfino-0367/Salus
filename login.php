...
if($r[3]=="police")
{
    ...
    header("location:police/emg.php");
...
<body>
	...
	<div class="main-top" id="home">
		...
		<div class="banner_w3lspvt-2">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="#" class="font-weight-bold">Login</a></li>
			...
			<div class="row">
				...
				<div class="col-lg-8 mt-lg-0 mt-5">
					...
					<div class="contact-top1">
                        ...
                        <input type="text" class="form-control" name="t1" placeholder="Email ID" required="">
                    ...
                    <div class="btnn">
                        <button class="btn btn-cont-w3 btn-block mt-4" name="sub" type="submit">Login </button>
                    </div>
