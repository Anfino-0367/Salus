	...
	<div class="row panel">
		<div class="col-md-4 bg_blur ">
                    <div>
                        ...
                        <br/>
                        <br/>
                        <h1 style="color: white"><?php echo $r1[2] ?></h1>
                <a style="color: white" href="tel:<?php echo $r1[3] ?>"><h4><?php echo $r1[3] ?></h4></a>
                <span style="color: blue;"  ><b><?php echo $r1[7] ?></b></span>
        ...
        <div class="col-md-8  col-xs-12">
           ...
           <iframe src="multimap/index.php?mid=<?php echo $mid ?>" style="height: 300px;width: 100%" ></iframe>
                ...
                <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog" style="background-color: white">
                        <iframe src="multimap/index.php?mid=<?php echo $mid ?>" style="height: 500px;width: 500px" ></iframe>
                <div >
                  <div>
