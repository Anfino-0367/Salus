...
?>
 <?php
                            if(isset($_GET['del']))
{
    $del1=mysqli_query($dbcon,"delete from loc where id='".$_GET['del']."'");
...
<body>
	...
	<div class="contact py-5" id="contact">
                 ...
                 <?php
                                                        ...
                                                        $sel_gal=mysqli_query($dbcon,"select * from loc where uid='$usr'");
				...
				<div class="col-lg-4 about-grid">
					<div class="about-grid-main">
						...
						<p><?php echo substr($r_gal['7'],0,55)?>.......</p>
                                                <br/>
                                                <a href="emg_dt.php?mid=<?php echo $r_gal[0] ?>" class="btn btn-success">Join</a>&nbsp;&nbsp;<a href="emg1.php?del=<?php echo $r_gal[0] ?>" class="btn btn-danger">Leave</a>
					</div>
				</div>
